...
export async function sendNewFollowerNotification(event: any) {
...
async function userEventExist(userId: string, kind: string, interactionRef = null): Promise<boolean> {
    let ref;
